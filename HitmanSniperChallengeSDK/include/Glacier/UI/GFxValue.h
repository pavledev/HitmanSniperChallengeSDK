...
class HitmanSniperChallengeSDK_API GFxValue
{
public:
	enum ValueType
	{
	...
	{
	public:
		bool GetMember(const char* name, GFxValue* pval, bool isdobj);
		bool SetMember(const char* name, const GFxValue& value, bool isdobj);
	};
