...
class HitmanSniperChallengeSDK_API ZHeaderLibrary
{
public:
...
private:
	...
	THashMap<ZRuntimeResourceID, ZEvent<ZRuntimeResourceID const&, ZEventNull, ZEventNull, ZEventNull, ZEventNull>, TDefaultHashMapPolicy<ZRuntimeResourceID>> m_ResourceUnloadedEvents;
};
